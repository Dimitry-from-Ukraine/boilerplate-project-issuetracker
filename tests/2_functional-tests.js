...
suite('Functional Tests', function() {
    this.beforeAll((done) => {
      ...
      test('A POST request to /api/issues/testProject with every issue field completed', (done) => {
        const issue_title = 'TEST ISSUE';
        const issue_text = 'Issue with all fields completed';
      ...
      test('A POST request to /api/issues/testProject with required issue fields filled', (done) => {
        const issue_title = 'TEST ISSUE';
        const issue_text =
          'Issue with only required fields filled';
        const created_by = 'Test Runner';
    ...
    test('A POST request to /api/issues/testProject missing required fields', (done) => {
    ...
    test('A GET request to /api/issues/testProject should return all the issues', (done) => {
        chai
          .request(server)
          ...
          .then((res) => {
            ...
            // Should be two issues, from the positive tests
    ...
    test('A GET request to /api/issues/testProject with a single filter field', (done) => {
        const issue_text = 'Issue with all fields completed';
        chai
          .request(server)
    ...
    test('A GET request to /api/issues/testProject with multiple filter fields', (done) => {
        const issue_title = 'TEST ISSUE';
        const issue_text = 'Issue with all fields completed';
        const created_by = 'Test Runner';
        const assigned_to = 'Test Assignee';
    ...
    test('A PUT request to /api/issues/testProject with one field to update', (done) => {
        const issue_title = 'TEST ISSUE';
        const issue_text = 'Issue with all fields completed';
        const created_by = 'Test Runner';
        const assigned_to = 'Test Assignee';
    ...
    test('A PUT request to /api/issues/testProject with multiple fields to update', (done) => {
        const issue_title = 'TEST ISSUE';
        const issue_text =
          'Issue with only required fields filled';
        const created_by = 'Test Runner';
    ...
    test('A PUT request to /api/issues/testProject with no _id', (done) => {
    ...
    test('A PUT request to /api/issues/testProject with a valid _id but no update fields', (done) => {
    ...
    test('A PUT request to /api/issues/testProject with an invalid _id', (done) => {
    ...
    test('A DELETE request to /api/issues/testProject with a valid _id', (done) => {
    ...
    test('A DELETE request to /api/issues/testProject with no _id', (done) => {
    ...
    test('A DELETE request to /api/issues/testProject with an invalid _id', (done) => {
        const _id = 123;
